 ...
 */
class AppAdapter(context: MainActivity, list: ArrayList<App>, private var listener: OnSignListener?) : BaseAdapter(context, list) {

    private var activity: MainActivity? = context
